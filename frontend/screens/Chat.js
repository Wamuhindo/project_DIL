...
const messages = [
  ...
  {
    id: 2,
    message: `I am pregnant for the fisrt time. I need some pieces of advice from you.`,
    time: `10:34 PM`,
  },
  {
    id: 3,
    avatar: angelos,
    message: `OK. Would you like to book an appointment?`,
    time: `10:35 PM`,
  },
  {
    id: 4,
    ...
    return (
      <Block key={msg.id}>
        <Block row space={!msg.avatar? 'between' : null}>
          <Image source={ msg.avatar } style={[styles.avatar, styles.shadow]} />
